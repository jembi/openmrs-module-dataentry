...
public class Utils {
	 ...
	 * @return
	 */
	public static Encounter createEncounter(Date encounterDate, Person provider,
		...
		try {
			...
			enc.setDateCreated(encounterDate);			
			enc.setUuid(OpenmrsUtil.generateUid());
	...
	public static boolean isAdultInit(Patient patient, String type) {
		...
		List<Encounter> encounters = encService.getEncountersByPatient(patient);
