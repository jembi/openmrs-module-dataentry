...
<table cellspacing="20px">
	...
	<td><spring:message code="dataentry.encType" /></td>
		<td>
			<select name="encounterTypeId" id="encTypeId">
				<option value="">---Encounter Type---</option>
				<c:forEach items="${encTypes}" var="encType" >
					<c:if test="${encType.encounterTypeId eq 3 || encType.encounterTypeId eq 4}">
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="nextVisitDate_5096" onfocus="showCalendar(this)" class="date" size="11" id="nextDOVId" /></td>
