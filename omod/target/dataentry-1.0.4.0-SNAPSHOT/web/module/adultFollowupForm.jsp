...
<openmrs:require privilege="View Data Entry" otherwise="/login.htm" redirect="/module/dataentry/adultFollowup.form" />
...
<table cellspacing="20px">
	<tr>
		...
		<td><select name="encProvider" id="encProviderId">
	...
	<tr>
		...
		<td><select name="encounterTypeId" id="encTypeId">
			...
			<c:forEach items="${encTypes}" var="encType">
				<c:if test="${encType.encounterTypeId eq 2 || encType.encounterTypeId eq 4}">
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="nextVisitDate_5096"
			onfocus="showCalendar(this)" class="date" size="11" id="nextDOVId" /></td>
		<td style="padding-left: 20px"><spring:message
			code="dataentry.nextVisitReason" /></td>
		<td><select name="nextVisitReason_8130" id="nextVisitReasonId">
